...
if (percentCorrect >= 60) {
  // se la percentuale é maggiore o uguale al 60%, stampo questo messaggio
  ...
  // se la percentuale é minore di 60%, stampo questo
